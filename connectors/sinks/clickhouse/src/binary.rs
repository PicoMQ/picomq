...
pub(crate) fn serialize_value(
    ...
    match ch_type {
        ...
        ChType::Tuple(field_types) => match value {
...
mod tests {
    ...
    fn serialize_map_entries_written_in_sorted_key_order() {
        ...
        expected.extend_from_slice(&[2, b'1', b'0']);
        expected.extend_from_slice(&4i32.to_le_bytes());
        expected.extend_from_slice(&[1, b'a']);
        expected.extend_from_slice(&1i32.to_le_bytes());
        expected.extend_from_slice(&[1, b'm']);
        expected.extend_from_slice(&2i32.to_le_bytes());
        expected.extend_from_slice(&[1, b'z']);
