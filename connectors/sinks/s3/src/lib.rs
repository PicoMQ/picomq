...
const DEFAULT_PATH_TEMPLATE: &str = "{topic}/{date}/{hour}";
const DEFAULT_OUTPUT_FORMAT: &str = "json_lines";
const MAX_S3_SINGLE_PUT_SIZE: u64 = 5 * 1024 * 1024 * 1024;
...
pub struct S3SinkConfig {
    ...
    #[serde(
        default,
        serialize_with = "picomq_connector_sdk::secret::serialize_optional_secret"
    )]
...
mod tests {
    ...
    fn config_deserialization_full() {
        let json = r#"{
            ...
            "path_template": "{topic_segment[0]}/{topic}",
