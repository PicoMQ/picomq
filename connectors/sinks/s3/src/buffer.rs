...
impl FileBuffer {
    ...
    pub fn append(&mut self, entry: &[u8], offset: u64, timestamp_millis: u64) {
        ...
        if self.first_offset.is_none() {
            ...
            self.first_timestamp_millis = timestamp_millis;
        }
    ...
    pub fn first_timestamp_millis(&self) -> u64 {
        self.first_timestamp_millis
    }
...
mod tests {
    ...
    fn append_tracks_offsets() {
        ...
        assert_eq!(buf.first_timestamp_millis(), 1000);
